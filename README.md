...
|------------------------------------------|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|registerUser                              |This method is used to authenticate the user from server.                                     |1.) name - name of the user. <br> 2.) email - email address of the user. <br> 3.) countryCode - country code. <br> 4.) phoneNumber - phone number of the user.                                                                                                                                                                                                                                                                                         |
...
|getOCRResultFromImage                     |to upload captured image to server and get the scanned data.                                  |1.) multipartDataArray - It requires array of 'MultipartDataModal' object. <br> 2.) assetSubTypeName - asset document name for eg: Passport and Identity card.                                                                                                                                                                                                                                                                                 |

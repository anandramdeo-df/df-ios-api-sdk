...
|------------------------------------------|----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|registerUser                              |This method is used to authenticate the user from server.                                     |1. name - name of the user  2. email - email address of the user  3. countryCode - country code  4. phoneNumber - phone number of the user                                                                                                                                                                                                                                                                                            |
...
|addUpdateAssetDetail                      |Add or update asset details except others type assets.                                        |1. assetSubTypeParent - requires parent type like identity or utility etc.  2. assetDetailId - It is optional field. When you adding asset details to server it is empty but when updating it has asset document id.  3. parametersDict - In this field, you need to pass the document information with geo_longitude and geo_latitude in a dictionary.                                                                               |
|addUpdateAssetDetailForOthers             |Add or update asset details for others type assets.                                           |1. multipartInfoArray - It requires array of 'MultipartDataModal' object.  2. assetSubTypeParent - It requires parent type like identity or utility etc.  3. assetDetailId - It is optional field. When you adding asset details to server it is empty but when updating it has asset document id.  4. comment - comment added to asset of other type  5. parametersDict - It requires dictionary with geo_longitude and geo_latitude.|
|getDocumentListing                        |get particular document information.                                                          |1. assetSubTypeId - asset document id  2. assetSubTypeParent - It requires parent type like identity or utility etc.                                                                                                                                                                                                                                                                                                                  |
|getAllSavedAssets                         |get all uploaded assets on server.                                                            |NA                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|deleteDocumentAsset                       |remove saved document asset from database.                                                    |1. assetURL - It requires parent type like identity or utility etc.  2. assetId - asset document id                                                                                                                                                                                                                                                                                                                                   |
...
|uploadAccessOfAssetToOrganisation         |This method is used to grant or deny access to uploaded asset.                                |1. id - id of request.  2. sharedWith - ID of organisation or admin with which asset will be shared  3. assetId - asset document id  4. timePeriod - Date upto which asset will be shared  5. status - value is either REJECTED or GRANTED                                                                                                                                                                                            |
|revokeAccessOfAssetToOrganisation         |This method is used to revoke access to organisation.                                         |1. assetId - asset document id  2. sharedWith - ID of organisation or admin with which asset will be shared                                                                                                                                                                                                                                                                                                                           |
|requestForShareByMeList                   |get the list of assets which were shared by me.                                               |NA                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|getOCRResultFromImage                     |to upload captured image to server and get the scanned data.                                  |1. multipartDataArray - It requires array of 'MultipartDataModal' object.  2. assetSubTypeName - asset document name for eg: Passport and Identity card.                                                                                                                                                                                                                                                                              |
